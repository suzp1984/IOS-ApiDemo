//
//  AudioSamplesViewController.swift
//  ApiDemo-Swift
//
...
class AudioSamplesViewController: UIViewController, UINavigationControllerDelegate,
                            UITableViewDelegate, UITableViewDataSource  {

    let cellIdentifier = "Audios"
    let demos: [String] = ["audio"]
